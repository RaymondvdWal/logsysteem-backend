...
public class UserController {
    ...
    public ResponseEntity<Object> addUserAuthority(@PathVariable("username") String username, @RequestBody Map<String, Object> fields) {
        try {
            ...
            throw new BadRequestException("No valid authority");
        }
    }
    ...
    @PutMapping("/{username}/profilePicture/{profilePicture_id}")
    public ResponseEntity<UserDto> assignProfilePictureToUser(@PathVariable("username") String username, @PathVariable("profilePicture_id") Long profilePictureId) {
        return ResponseEntity.ok(userService.assignProfilePictureToUser(username,profilePictureId));
    }
